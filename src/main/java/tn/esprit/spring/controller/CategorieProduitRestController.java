...
public class CategorieProduitRestController {
	...
	// http://localhost:8089/SpringMVC/categorieProduit/retrieve-all-categorieProduits
	@GetMapping("/retrieve-all-categorieProduits")
	@ResponseBody
	...
	@ResponseBody
	public CategorieProduit addCategorieProduit(@RequestBody CategorieProduit o) {
		CategorieProduit categorieProduit = categorieProduitService.addCategorieProduit(o);
	...
	public void removeCategorieProduit(@PathVariable(" categorieProduit-id") Long categorieProduitId) {
		categorieProduitService.removeCategorieProduit(categorieProduitId);
	}
